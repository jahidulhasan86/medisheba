...
Strophe.addConnectionPlugin('muc', {
  ...
  */
  // for groupMessage only (without file)
  ...
  //   }).t(new Date().getTime()).c("composing");
  //   this._connection.send(msg);
  //   return msgid;
  // },

  // for group message with file
  message: function(room, nick, message, html_message, type, contentType, thumbnailLink, callObj) {

    var msg, msgid, parent, room_nick, timestamp;
    room_nick = this.test_append_nick(room, nick);
    type = type || (nick != null ? "chat" : "groupchat");
    msgid = this._connection.getUniqueId();
    ...
    if(callObj){
      ...
      .up().c("content", { xmlns: 'urn:xmpp:content', type: contentType }).t(thumbnailLink)
      .up().c("CallSession", { xmlns: 'urn:xmpp:callSession', CallSessionId : callObj.callSessionId , ConferenceId : callObj.conferenceId, ConferenceType : callObj.conferenceType });
  ...
  */
  ...
  // },
  groupchat: function(room, message, html_message, contentType, thumbnailLink, callObj) {
    return this.message(room, null, message, html_message, null, contentType, thumbnailLink, callObj);
  },
  /*Function
