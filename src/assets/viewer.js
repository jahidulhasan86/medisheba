  ...
  function ImageViewer(canvasId, imageUrl, options){
    ...
    function render(){
      ...
      if(dirty){
        ...
        console.log("width: "+canvas.width, "height: "+canvas.height,"translatex: "+translateX,"translateY: " +translateY, "scale: "+scale);
        ctx.translate(translateX, translateY);
        ctx.scale(scale, scale);
        console.log(self.image.height, "width : "+ self.image.width);
